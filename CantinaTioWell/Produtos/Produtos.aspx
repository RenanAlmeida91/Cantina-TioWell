<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Produtos.aspx.cs" Inherits="CantinaTioWell.Produtos.Produtos" %>
...
<head>
    ...
    <title>Produtos - Cantina do Tio Well</title>
                    ...
                    <div class="navbar-collapse collapse">
                        <div class="menu">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a href="Funcionarios/Funcionarios.aspx">Funcionários</a></li>
                                <li role="presentation"><a href="#" class="active">Produtos</a></li>
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <table class="table table-hover">
                    ...
                    <tbody id="tabprodutos" runat="server">
                    </tbody>
                </table>
            </div>
            <%-- Fim Grid consulta --%>
            ...
            <div class="col-md-5" id="cadProdutos">
                <h3>Pesquisa/Cadastro de produtos</h3>
                <p>Use o formulário abaixo para cadastrar, pesquisar e atualizar os produtos que estão à venda.</p>
                <form action="" method="post" role="form" class="contactForm" runat="server">
                    <div class="form-group">
                        ...
                        <asp:Button runat="server" ID="btnConsultaID" Text="Consultar ID" CssClass="btn btn-default" />
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtProd" runat="server" MaxLength="40" CssClass="form-control" />
                        <asp:Button runat="server" ID="btnConsultaProd" Text="Consultar Produto" CssClass="btn btn-default" />
                    </div>
                    ...
                    <div class="content align-center">
                        ...
                        <div class="form-group" id="botaocadastro" runat="server" hidden="hidden">
                            <asp:Button runat="server" ID="btnEnviaCad" Text="Cadastrar Produto" CssClass="btn btn-default" />
                        </div>

                        <div class="form-group" id="botoeseditar" runat="server" hidden="hidden">
                            <asp:Button runat="server" ID="btnUpdProd" Text="Atualizar Produto" CssClass="btn btn-default" />
                            <asp:Button runat="server" ID="btnDeleta" Text="Deletar Produto" CssClass="btn btn-default" />
                        </div>

                        <div class="form-group" id="botaolimpar">
                            <asp:Button runat="server" ID="btnLimpar" Text="Limpar" CssClass="btn btn-default" />
                        </div>
